...
function outJson($enterp_id){
    $conn = mysql_conn();
    $full_sql = "select * from enterprise where enterpID = '$enterp_id'";
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="EnterpInfo.php">Overview <span class="sr-only">(current)</span></a></li>
                ...
                columns: [
                    {
                        ...
                        field: 'enterpLegalPerson',
                        title: '企业法人',
                        align: 'center',
                        valign: 'middle'
                    },{
                        field: 'enterPhoneNumber',
                        title: '企业电话',
                        align: 'center',
                        valign: 'middle'
                    }
